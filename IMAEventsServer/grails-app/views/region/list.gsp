			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="regionName" title="${message(code: 'region.regionName.label', default: 'Region Name')}" />
				...
				<g:each in="${regionInstanceList}" status="i" var="regionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${regionInstance.id}">${fieldValue(bean: regionInstance, field: "regionName")}</g:link></td>
