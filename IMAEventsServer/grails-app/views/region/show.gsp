		...
		<div id="show-region" class="content scaffold-show" role="main">
			...
			<ol class="property-list region">
				...
				<li class="fieldcontain">
					<span id="regionName-label" class="property-label"><g:message code="region.regionName.label" default="Region Name" /></span>
					
						<span class="property-value" aria-labelledby="regionName-label"><g:fieldValue bean="${regionInstance}" field="regionName"/></span>
